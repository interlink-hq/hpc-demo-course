...
2. **[Machine 1 - SLURM Setup](docs/machine1-slurm.md)** - 20-30 minutes
...
4. **[Interlink Setup](docs/interlink-setup.md)** - 20-30 minutes
...
**Note**: All guides are tested and verified on actual hardware.
